...
class ExpensesModel extends Model implements IModel{
    ...
    //utilizo n para limitar la consulta los expenses de un usuario
    ...
    //Obtiene el total de amount (cantidad) de expenses basado en id de categoria
