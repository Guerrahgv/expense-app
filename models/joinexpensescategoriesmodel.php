...
//creando un modelo basado en los ya existentes por eso el Join
class JoinExpensesCategoriesModel extends Model{
    ...
    //la union de las tables de expenses y categories deonde la cate de expen sea igual a la categoria y que sean del mismo usuario
    ...
    //manejando los datos de la grafica
    //obtengo el total por mes por categoria
